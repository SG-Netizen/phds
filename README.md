...
- [x] **v0.1.0** — 核心协议：Ed25519 密钥、AES-256-GCM 加密、JWT 授权、FastAPI 接口 ✅ 已完成
- [x] **v0.1.1** — 链上存证 + SM2 国密演示 + 完整文档 ✅ 已完成
- [ ] **v0.2.0** — 国密完整支持：SM2 密钥交换、SM4 对称加密、SM9 标识密码 🔄 进行中
- [ ] **v0.3.0** — 分布式存储：IPFS 集成、多节点冗余
- [ ] **v0.4.0** — 零知识证明：不暴露数据前提下的属性验证
- [ ] **v0.5.0** — 联邦学习：跨机构联合计算
